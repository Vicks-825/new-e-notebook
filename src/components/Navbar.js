...
const Navbar = () => {
  return (
    ...
    <div className="collapse navbar-collapse flex flex-row flex-grow items-center" id="navbarSupportedContent">
    ...
    <ul className="navbar-nav flex flex-row pl-0 list-style-none mr-auto">
      ...
      <li className="nav-item pr-2">
        <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to="/about">About</Link>
      </li>
    </ul>
    </div>
    </div>
